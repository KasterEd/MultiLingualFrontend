...
export const aboutContent: AboutContent = {
  ...
  gsjj: {
    ...
    content: [
      {
        zh: '复临开泰是一家专注模块化建筑与临建系统解决方案的企业，集研发、生产、销售与服务于一体。',
        kz: 'Fulinkaitai — модульді құрылыс және уақытша нысандар шешімдеріне маманданған, ҒЗТКЖ, өндіріс, сату және сервисті біріктіретін компания.',
        ru: 'Fulinkaitai — компания, специализирующаяся на модульном строительстве и временных объектах, объединяющая R&D, производство, продажи и сервис.',
      },
      {
  ...
  qyzizhi: {
    ...
    // 可在页面中以网格展示证书图
    images: [
      '/src/assets/about/cert-iso.jpg',
      '/src/assets/about/cert-product.jpg',
    ],
  },
