...
export const partners: Partner[] = [
  {
    ...
    logo: new URL('@/assets/partners/cscec.png', import.meta.url).href,
    url: '#',
    blurb: {
  ...
  },
  {
    ...
    logo: new URL('@/assets/partners/energy.png', import.meta.url).href,
    url: '#',
    blurb: {
  ...
  },
  {
    ...
    logo: new URL('@/assets/partners/tourism.png', import.meta.url).href,
    url: '#',
    blurb: {
