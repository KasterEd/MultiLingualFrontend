...
export const productCategories: ProductCategory[] = [
  { slug: 'folding-house',          image: new URL('@/assets/products/1.jpg', import.meta.url).href, name: { zh:'折叠式活动房', kz:'Жиналмалы үй', ru:'Складной модульный дом' } },
  { slug: 'packaged-box',           image: new URL('@/assets/products/2.jpg', import.meta.url).href, name: { zh:'打包箱',       kz:'Жиналмалы қорап', ru:'Блок-контейнер (упаковочный)' } },
  { slug: 'assembled-container',    image: new URL('@/assets/products/3.jpg', import.meta.url).href, name: { zh:'装配式集装箱', kz:'Жиналмалы контейнер', ru:'Сборный контейнер' } },
  { slug: 'three-floor-house',      image: new URL('@/assets/products/4.jpg', import.meta.url).href, name: { zh:'三层组合活动房', kz:'Үш қабатты құрастырмалы үй', ru:'Трёхэтажный модульный дом' } },
  { slug: 'quake-proof-container',  image: new URL('@/assets/products/5.jpg', import.meta.url).href, name: { zh:'抗震集装箱',   kz:'Сейсмотұрақты контейнер', ru:'Сейсмоустойчивый контейнер' } },
  { slug: 'rental-products',        image: new URL('@/assets/products/6.jpg', import.meta.url).href, name: { zh:'租赁产品',     kz:'Жалға берілетін өнімдер', ru:'Арендные продукты' } },
  { slug: 'foldable-splicing-room', image: new URL('@/assets/products/7.jpg', import.meta.url).href, name: { zh:'折叠共拼箱',   kz:'Жиналмалы біріктірілетін бөлме', ru:'Складной модуль для стыковки' } },
  { slug: 'equipment-box',          image: new URL('@/assets/products/8.jpg', import.meta.url).href, name: { zh:'设备箱',       kz:'Жабдық қорабы', ru:'Оборудовательный ящик' } },
  { slug: 'dual-extension-box',     image: new URL('@/assets/products/9.jpg', import.meta.url).href, name: { zh:'双翼扩展箱',   kz:'Қос қанатты кеңейтілетін қорап', ru:'Контейнер с двойным расширением' } },
]
...
export const products: Product[] = [
  {
    ...
    cover: new URL('@/assets/products/1.jpg', import.meta.url).href,
    bullets: [
    ...
    gallery: [new URL('@/assets/products/fh-01-1.jpg', import.meta.url).href, new URL('@/assets/products/fh-01-2.jpg', import.meta.url).href],
  },
  {
    slug: 'pb-01',
    ...
    cover: new URL('@/assets/products/2.jpg', import.meta.url).href,
  },
  {
    slug: 'ac-01',
    ...
    cover: new URL('@/assets/products/3.jpg', import.meta.url).href,
  },
  ...
  cover: new URL('@/assets/products/4.jpg', import.meta.url).href,
},
{
  slug: 'qpc-01',
  ...
  cover: new URL('@/assets/products/5.jpg', import.meta.url).href,
},
{
  slug: 'rent-01',
  ...
  cover: new URL('@/assets/products/6.jpg', import.meta.url).href,
},
{
  slug: 'fsr-01',
  ...
  cover: new URL('@/assets/products/7.jpg', import.meta.url).href,
},
{
  slug: 'eqb-01',
  ...
  cover: new URL('@/assets/products/8.jpg', import.meta.url).href,
},
{
  slug: 'deb-01',
  ...
  cover: new URL('@/assets/products/9.jpg', import.meta.url).href,
}
