...
export const productCategories: ProductCategory[] = [
  { slug: 'folding-house',          image: '@/assets/products/1.jpg', name: { zh:'折叠式活动房', kz:'Жиналмалы үй', ru:'Складной модульный дом' } },
  { slug: 'packaged-box',           image: '@/assets/products/2.jpg', name: { zh:'打包箱',       kz:'Жиналмалы қорап', ru:'Блок-контейнер (упаковочный)' } },
  { slug: 'assembled-container',    image: '@/assets/products/3.jpg', name: { zh:'装配式集装箱', kz:'Жиналмалы контейнер', ru:'Сборный контейнер' } },
  { slug: 'three-floor-house',      image: '@/assets/products/4.jpg', name: { zh:'三层组合活动房', kz:'Үш қабатты құрастырмалы үй', ru:'Трёхэтажный модульный дом' } },
  { slug: 'quake-proof-container',  image: '@/assets/products/5.jpg', name: { zh:'抗震集装箱',   kz:'Сейсмотұрақты контейнер', ru:'Сейсмоустойчивый контейнер' } },
  { slug: 'rental-products',        image: '@/assets/products/6.jpg', name: { zh:'租赁产品',     kz:'Жалға берілетін өнімдер', ru:'Арендные продукты' } },
  { slug: 'foldable-splicing-room', image: '@/assets/products/7.jpg', name: { zh:'折叠共拼箱',   kz:'Жиналмалы біріктірілетін бөлме', ru:'Складной модуль для стыковки' } },
  { slug: 'equipment-box',          image: '@/assets/products/8.jpg', name: { zh:'设备箱',       kz:'Жабдық қорабы', ru:'Оборудовательный ящик' } },
  { slug: 'dual-extension-box',     image: '@/assets/products/9.jpg', name: { zh:'双翼扩展箱',   kz:'Қос қанатты кеңейтілетін қорап', ru:'Контейнер с двойным расширением' } },
]
...
export const products: Product[] = [
  {
    ...
    gallery: ['@/assets/products/fh-01-1.jpg', '@/assets/products/fh-01-2.jpg'],
  },
  {
    slug: 'pb-01',
